    ...
    public static final String CONTENT_EVENT_MAIL = """
            <ul class="list-unstyled">
                                       ...
                                       <li>
                                         ...
                                         <strong style="text-transform: uppercase">{maDonHang}</strong>.
                                           ...
                                           <tbody>
                                             <tr>
                                               <td scope="col">
                                                 ...
                                                 <h6>
                                                   Ngày đặt hàng:<strong style="text-transform: uppercase"
                                                     >{ngayDatHang}</strong
                                                   >
                                                 </h6>
                                                 <h6>
                                               ...
                                               <td scope="col">
                                                 ...
                                                 <h6>
                                                   Tên khách hàng:<strong style="text-transform: uppercase"
                                                     >{tenKhachHang}</strong
                                                   >
                                                 </h6>
                                                 <h6>
                                                   Địa chỉ:<strong style="text-transform: uppercase"
                                                     >{diaChi}</strong
                                                   >
                                                 </h6>
                                                 <h6>
                                     ...
                                     <div>
                                       <img src="cid:camOnImage" height="80px" alt="Cảm ơn" />
                                       <img src="cid:camKetImage" height="80px" alt="Cam kết" />
                                     </div>
                                     <div>
                                       ...
                                       <br />
                                       <img src="cid:lienHeImage" height="80px" alt="liên hệ" />
                                       <br />
                                       <img src="cid:theoDoiImage" height="80px" alt="Theo dõi" />
                                     </div>
            """;
