            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                    ...
                    <Accordion.Collapse eventKey="sidebar-auth">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/chi-tiet-san-pham' ? 'active' : ''} nav-link`} to="/chi-tiet-san-pham">
                                    <i className="icon">
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/mau-sac' ? 'active' : ''} nav-link`} to="/mau-sac">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/chip' ? 'active' : ''} nav-link`} to="/chip">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/camera' ? 'active' : ''} nav-link`} to="/camera">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/dong-san-pham' ? 'active' : ''} nav-link`} to="/dong-san-pham">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/hinh-thuc-san-pham' ? 'active' : ''} nav-link`} to="/hinh-thuc-san-pham">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/man-hinh' ? 'active' : ''} nav-link`} to="/man-hinh">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/nha-san-xuat' ? 'active' : ''} nav-link`} to="/nha-san-xuat">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/san-pham' ? 'active' : ''} nav-link`} to="/san-pham">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/nhan-vien' ? 'active' : ''} nav-link`} to="/nhan-vien">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/khach-hang' ? 'active' : ''} nav-link`} to="/khach-hang">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/chuc-vu' ? 'active' : ''} nav-link`} to="/chuc-vu">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
