...
const ManagementRoms = () => {
  ...
  const [romPages, setRomPages] = useState([]);
              ...
              <Popconfirm
                title={
                  <span style={{ fontSize: "16px" }}>
                    Bạn có chắc chắn đổi trạng thái rom?
                  </span>
                }
                onConfirm={() => {
  ...
  const [romCode, setRomCode] = useState("");
