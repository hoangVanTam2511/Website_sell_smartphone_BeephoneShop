...
const ModalCauHinh = ({ open, close, add }) => {
  ...
  const IconTrash = () => {
    return (
      <>
        <svg fill="none" color="#e5383b" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <DialogContent className="">
          <div style={{ width: "1100px", height: "auto" }}>
            <div className="text-center mt-1" style={{}}>
              <span className="" style={{ fontWeight: "550", fontSize: "29px" }}>LỰA CHỌN CẤU HÌNH</span>
            </div>
              ...
              <Button
                onClick={() => {
                  if (!ram) {
                    ...
                    setCauHinhs((cauHinhs) => [...cauHinhs, cauHinhMoi].sort((a, b) => a.ram.dungLuong - b.ram.dungLuong));
          ...
          <div style={{ width: "600px", height: "auto" }}>
            ...
            <div className="mx-auto mt-3" style={{ width: "100%" }}>
              <FormControl fullWidth>
                ...
                >
                  <MenuItem style={{ display: "none" }} value={0}>{selectColorSelected ? joinedColorsSelected : "Chọn Màu Sắc"}</MenuItem>
                  <MenuItem value={1}
                    disableRipple
                    style={{ backgroundColor: "transparent", display: "block", cursor: "auto", width: "1098px" }}
                  >
            ...
            <Button
              onClick={() => {
                if (!selectedRam) {
                  ...
                  updateData(selectedId, defaultRam, defaultRom, valueColorFinalSelected);
                  ...
                  updateData(selectedId, selectedRam, selectedRom, valueColorFinalSelected);
                  handleCloseModalUpdate();
                  handleOpenAlertVariant("Cập nhật cấu hình thành công!", Notistack.SUCCESS);
                }
              }}
