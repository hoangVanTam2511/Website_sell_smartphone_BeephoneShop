...
const CreateRom = ({ close }) => {
  ...
  const niqueRom = roms.map((option) => option.dungLuong).filter((value, index, self) => {
      ...
      <div className="mt-4" style={{ width: "700px" }}>
        <div className="container" style={{}}>
          <div className="text-center" style={{}}>
            <span className="" style={{ fontWeight: "550", fontSize: "29px" }}>THÊM ROM</span>
          </div>
