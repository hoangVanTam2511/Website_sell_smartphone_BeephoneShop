...
const CreateSac = ({ close }) => {
  ...
  const uniqueCongSac = congSacs.map((option) => option.congSac).filter((value, index, self) => {
      ...
      <div className="mt-4" style={{ width: "700px" }}>
        <div className="container" style={{}}>
          <div className="text-center" style={{}}>
            <span className="" style={{ fontWeight: "550", fontSize: "29px" }}>THÊM CỔNG SẠC</span>
          </div>
