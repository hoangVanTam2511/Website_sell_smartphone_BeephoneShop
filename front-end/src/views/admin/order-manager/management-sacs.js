...
const ManagementCongSacs = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "loaiCongSac",
      width: "15%",
      dataIndex: "loaiCongSac",
      render: (text, record) => (
        <span style={{ fontWeight: "400" }}>{record.loaiCongSac}</span>
      ),
    },
    {
      title: "Trạng Thái",
              ...
              <Popconfirm
                title={
                  <span style={{ fontSize: "16px" }}>
                    Bạn có chắc chắn đổi trạng thái cổng sạc?
                  </span>
                }
                onConfirm={() => {
  ...
  const handleChangeLoaiCongSac = (event, value) => {
...
export default ManagementCongSacs;
