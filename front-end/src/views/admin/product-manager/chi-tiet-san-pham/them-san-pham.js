                    ...
                    <Row>
                        ...
                        <Col span={11}>
                            <Form.Group className="form-group">
                                ...
                                <Form.Label htmlFor="pwd" style={{ width: 150, color: 'black' }} >Camera trước
                                </Form.Label>
                                <Select
                                    mode="multiple"
                                    tagRender={cyan}
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Group className="form-group">
                                ...
                                <Form.Label htmlFor="pwd" style={{ width: 150, color: 'black' }} >Hệ điều hành
                                </Form.Label>
                        ...
                        <Col span={12}>
                            <Form.Group className="form-group">
                                ...
                                <Form.Label htmlFor="pwd" style={{ width: 150, color: 'black' }} >Sim
                                </Form.Label>
                                <Space direction="vertical">
                                    <Segmented
                                        options={[
                    ...
                    <Row>
                        ...
                        <Col span={24}>
                            <Form.Group className="form-group">
                                ...
                                <Form.Label htmlFor="pwd" style={{ width: 150, color: 'black' }} >Cổng sạc
                                </Form.Label>
                                <Space direction="vertical">
                                    <Segmented
                                        options={[
