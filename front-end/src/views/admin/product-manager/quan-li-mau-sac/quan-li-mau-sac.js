...
const BootstrapTable = () => {
  ...
  const loadUsers = async (page) => {
    const result = await axios.get(`http://localhost:8080/mau-sac/view-all?page=${page}`)
  ...
  const deleteColor = async (id) => {
    await axios.delete(`http://localhost:8080/mau-sac/delete?id=${id}`)
    loadUsers()
  }
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between">
              <div className="header-title">
                <h4 className="card-title">Quản lí màu sắc
